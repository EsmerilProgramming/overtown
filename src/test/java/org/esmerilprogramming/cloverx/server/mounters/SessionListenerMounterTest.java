...
import org.esmerilprogramming.cloverx.server.mounters.helpers.TestSessionListener;
...
public class SessionListenerMounterTest {
  ...
  @Test
  public void doesReturnTrueWhenIsAValidOnSessionCreateMethodWithCloverXSessionAsParameter() throws NoSuchMethodException, SecurityException{
    Method method = TestSessionListener.class.getMethod("onCreateMethodTest", CloverXSession.class);
  ...
  @Test
  public void doesReturnTrueWhenIsAValidOnSessionDestroyMethodWithCloverXSessionAsParameter() throws NoSuchMethodException, SecurityException{
    Method method = TestSessionListener.class.getMethod("onDestroyMethodTest", CloverXSession.class);
  ...
  @Test
  public void doesReturnTrueWhenIsAValidOnSessionDestroyMethodWithCloverXSessionAndSessionDestroyReasonAsParameter() throws NoSuchMethodException, SecurityException{
    Method method = TestSessionListener.class.getMethod("onDestroyMethodTest", CloverXSession.class , SessionDestroyedReason.class);
